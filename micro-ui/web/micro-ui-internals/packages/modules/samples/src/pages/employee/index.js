...
import ConnectionConfirmation from "./ApplyWaterConnectionConfirmation";
import ApplyConnection from "./ApplyWaterConnection";
import SearchWaterConnection from "./SearchWaterConnection";
  ...
  return (
    <Switch>
      <AppContainer className="ground-container">
        ...
        <PrivateRoute path={`${path}/apply-connection`} component={() => <ConnectionConfirmation />} />
        <PrivateRoute path={`${path}/apply-connection-form`} component={() => <ApplyConnection />} />
        <PrivateRoute path={`${path}/search-connection`} component={() => <SearchWaterConnection />} />
      </AppContainer>
    </Switch>
  );
};
